...
Font.register({
  family: 'ALS Hauss',
  fonts: [
    { src: process.env.PUBLIC_URL + '/fonts/ALS_Hauss_Regular_1.002.otf', fontWeight: 400 }, // font-style: normal, font-weight: normal
    { src: process.env.PUBLIC_URL + '/fonts/ALS_Hauss_Medium_1.2.otf', fontWeight: 500 },
    { src: process.env.PUBLIC_URL + '/fonts/ALS_Hauss_Bold_1.002.otf', fontWeight: 700 },
  ],
});
